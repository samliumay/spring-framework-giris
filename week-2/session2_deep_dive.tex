...
{\Huge\bfseries SESSION 2}\\[0.8cm]
{\Huge\bfseries Kimin \.{I}\c{s}i Ne?}\\[1.2cm]
{\large Service Katman{\i}, IoC, Dependency Injection \& Strategy Pattern}\\[0.8cm]
{\color{accentred}\rule{0.6\textwidth}{2pt}}\\[1.2cm]
{\normalsize\textbf{Umay \c{S}AMLI}}\\[0.3cm]
{\small \href{mailto:umay.samli@infinitumit.com.tr}{umay.samli@infinitumit.com.tr} \textbar{} \href{mailto:samliumay965@gmail.com}{samliumay965@gmail.com}}\\[1.5cm]
...
\texttt{@Autowired} ile do\u{g}rudan alana enjekte edilir. Test i\c{c}in mock vermek zordur.
...
Strategy Pattern'in Spring Boot ile kullan{\i}m{\i}n{\i} daha detayl{\i} incelemek isterseniz \cite{strategy-spring-boot} kayna\u{g}{\i}na bakabilirsiniz.
